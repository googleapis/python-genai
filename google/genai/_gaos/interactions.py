...
class Interactions(BaseSDK):
    ...
    def create(
        ...
        *,
        ...
        :param usage: Statistics on the interaction request's token usage.
        ...
        if retries == UNSET:
            if self.sdk_configuration.retry_config is not UNSET:
                ...
                retries = utils.RetryConfig(
                    "backoff", utils.BackoffStrategy(500, 8000, 2, 30000), True
                )
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "200", "application/json"):
                ...
                return unmarshal_json_response(
                    interactions.Interaction, http_res, http_res_text
                )
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                http_res_text = utils.stream_to_text(http_res)
                response_data = unmarshal_json_response(
                    errors.GetInteractionByIDClientErrorData, http_res, http_res_text
                )
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                http_res_text = utils.stream_to_text(http_res)
                response_data = unmarshal_json_response(
                    errors.GetInteractionByIDServerErrorData, http_res, http_res_text
                )
    ...
    def cancel(
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            response_data: Any = None
            if utils.match_response(http_res, "200", "application/json"):
                return unmarshal_json_response(interactions.Interaction, http_res)
            if utils.match_response(http_res, "4XX", "application/json"):
                response_data = unmarshal_json_response(
                    errors.CancelInteractionByIDClientErrorData, http_res
                )
                raise errors.CancelInteractionByIDClientError(response_data, http_res)
            if utils.match_response(http_res, "5XX", "application/json"):
                response_data = unmarshal_json_response(
                    errors.CancelInteractionByIDServerErrorData, http_res
                )
                raise errors.CancelInteractionByIDServerError(response_data, http_res)
