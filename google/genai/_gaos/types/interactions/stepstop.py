...
class StepStopMetadataTypedDict(TypedDict):
...
class StepStopMetadata(BaseModel):
    r"""Optional metadata accompanying ANY streamed event."""
...
class StepStopTypedDict(TypedDict):
    ...
    this event.
    """
    metadata: NotRequired[StepStopMetadataTypedDict]
    r"""Optional metadata accompanying ANY streamed event."""
...
class StepStop(BaseModel):
    ...
    metadata: Optional[StepStopMetadata] = None
    r"""Optional metadata accompanying ANY streamed event."""
