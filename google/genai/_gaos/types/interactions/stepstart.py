...
class StepStartMetadataTypedDict(TypedDict):
...
class StepStartMetadata(BaseModel):
    r"""Optional metadata accompanying ANY streamed event."""
...
class StepStartTypedDict(TypedDict):
    ...
    this event.
    """
    metadata: NotRequired[StepStartMetadataTypedDict]
    r"""Optional metadata accompanying ANY streamed event."""
...
class StepStart(BaseModel):
    ...
    metadata: Optional[StepStartMetadata] = None
    r"""Optional metadata accompanying ANY streamed event."""
