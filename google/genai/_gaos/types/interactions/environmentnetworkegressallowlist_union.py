...
EnvironmentNetworkEgressAllowlistEnum = Literal["disabled",]
...
EnvironmentNetworkEgressAllowlistUnionParam = TypeAliasType(
    "EnvironmentNetworkEgressAllowlistUnionParam",
    Union[
        EnvironmentNetworkEgressAllowlistParam, EnvironmentNetworkEgressAllowlistEnum
    ],
)
...
EnvironmentNetworkEgressAllowlistUnion = TypeAliasType(
    "EnvironmentNetworkEgressAllowlistUnion",
    Union[EnvironmentNetworkEgressAllowlist, EnvironmentNetworkEgressAllowlistEnum],
)
r"""Outbound networking configuration for the sandbox. Accepts an object with an 'allowlist' array to restrict traffic, or the string 'disabled' to turn off all network access. Omit entirely to allow all outbound traffic with no header injection."""
