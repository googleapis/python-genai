...
from .types import OptionalNullable, UNSET, agents
from .types.agents import (
    agent as agents_agent,
    agenttool as agents_agenttool,
)
...
class LocationsAgents(BaseSDK):
    @property
    def with_raw_response(self):
        return LocationsAgentsWithRawResponse(self)

    @property
    def with_streaming_response(self):
        return LocationsAgentsWithStreamingResponse(self)

    def update_agent_by_projects_id_and_locations_id_and_agents_id(
        self,
        agents_id: str,
        locations_id: str,
        projects_id: str,
        *,
        ...
        :param agents_id:
        :param locations_id:
        :param projects_id: Required. The name of the agent to update. or
            `agents/{agent}`
        ...
        request = models.UpdateAgentByProjectsIDAndLocationsIDAndAgentsIDRequest(
        ...
        req = self._build_request(
            method="PATCH",
            path="/{api_version}/projects/{projectsId}/locations/{locationsId}/agents/{agentsId}",
            base_url=base_url,
            ...
            _globals=models.UpdateAgentByProjectsIDAndLocationsIDAndAgentsIDGlobals(
        ...
        _speakeasy_hook_ctx = HookContext(
            ...
            operation_id="UpdateAgentByProjectsIdAndLocationsIdAndAgentsId",
            oauth2_scopes=None,
            security_source=get_security_from_env(
                self.sdk_configuration.security, types.Security
            ),
            tags=["projects.locations.agents"],
            extensions=None,
...
class LocationsAgentsWithRawResponse:
    def __init__(self, sdk: LocationsAgents) -> None:
        self._sdk = sdk
        self.update_agent_by_projects_id_and_locations_id_and_agents_id = (
            response_helpers.to_raw_response_wrapper(
                sdk.update_agent_by_projects_id_and_locations_id_and_agents_id,
                "extra_headers",
            )
        )


class LocationsAgentsWithStreamingResponse:
    def __init__(self, sdk: LocationsAgents) -> None:
        self._sdk = sdk
        self.update_agent_by_projects_id_and_locations_id_and_agents_id = (
            response_helpers.to_streamed_response_wrapper(
                sdk.update_agent_by_projects_id_and_locations_id_and_agents_id,
                "extra_headers",
            )
        )
...
class AsyncLocationsAgents(AsyncBaseSDK):
    @property
    def with_raw_response(self):
        return AsyncLocationsAgentsWithRawResponse(self)

    @property
    def with_streaming_response(self):
        return AsyncLocationsAgentsWithStreamingResponse(self)

    async def update_agent_by_projects_id_and_locations_id_and_agents_id(
        self,
        agents_id: str,
        locations_id: str,
        projects_id: str,
...
class AsyncLocationsAgentsWithRawResponse:
    def __init__(self, sdk: AsyncLocationsAgents) -> None:
        self._sdk = sdk
        self.update_agent_by_projects_id_and_locations_id_and_agents_id = (
...
class AsyncLocationsAgentsWithStreamingResponse:
    def __init__(self, sdk: AsyncLocationsAgents) -> None:
        self._sdk = sdk
        self.update_agent_by_projects_id_and_locations_id_and_agents_id = (
