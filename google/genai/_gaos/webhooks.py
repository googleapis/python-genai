        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "default", "application/json"):
                return unmarshal_json_response(webhooks.Webhook, http_res)
    ...
    def list(
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "default", "application/json"):
                return unmarshal_json_response(webhooks.WebhookListResponse, http_res)
    ...
    def delete(
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "default", "application/json"):
                return unmarshal_json_response(interactions.Empty, http_res)
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "default", "application/json"):
                return unmarshal_json_response(
                    webhooks.WebhookRotateSigningSecretResponse, http_res
                )
    ...
    def ping(
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "default", "application/json"):
                return unmarshal_json_response(webhooks.WebhookPingResponse, http_res)
