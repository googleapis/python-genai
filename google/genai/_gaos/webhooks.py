...
class Webhooks(BaseSDK):
    ...
    def list(
        ...
        *,
        ...
        :param page_size: The maximum number of webhooks to return. The service may return fewer than
            this value. If unspecified, at most 50 webhooks will be returned.
            The maximum value is 1000.
        :param page_token: A page token, received from a previous `ListWebhooks` call.
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.ListWebhooksClientErrorData, http_res
                    )
                    raise errors.ListWebhooksClientError(response_data, http_res)
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.ListWebhooksServerErrorData, http_res
                    )
                    raise errors.ListWebhooksServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.CreateWebhookClientErrorData, http_res
                    )
                    raise errors.CreateWebhookClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.CreateWebhookServerErrorData, http_res
                    )
                    raise errors.CreateWebhookServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.GetWebhookClientErrorData, http_res
                    )
                    raise errors.GetWebhookClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.GetWebhookServerErrorData, http_res
                    )
                    raise errors.GetWebhookServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.DeleteWebhookClientErrorData, http_res
                    )
                    raise errors.DeleteWebhookClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.DeleteWebhookServerErrorData, http_res
                    )
                    raise errors.DeleteWebhookServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.UpdateWebhookClientErrorData, http_res
                    )
                    raise errors.UpdateWebhookClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.UpdateWebhookServerErrorData, http_res
                    )
                    raise errors.UpdateWebhookServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
    ...
    def ping(
        ...
        *,
        ...
        :param body: Required. The HTTP body of the payload.
        :param extra_headers: Additional headers to set or replace on requests.
        :param extra_query: Additional query parameters to append to requests.
        :param extra_body: Additional JSON object fields to merge into request bodies.
        :param timeout: Override the default request timeout configuration for this method in seconds
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.PingWebhookClientErrorData, http_res
                    )
                    raise errors.PingWebhookClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.PingWebhookServerErrorData, http_res
                    )
                    raise errors.PingWebhookServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
        ...
        *,
        ...
        def _speakeasy_parse_response(http_res):
            ...
            if utils.match_response(http_res, "4XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.RotateSigningSecretClientErrorData, http_res
                    )
                    raise errors.RotateSigningSecretClientError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
            ...
            if utils.match_response(http_res, "5XX", "application/json"):
                try:
                    response_data = unmarshal_json_response(
                        errors.RotateSigningSecretServerErrorData, http_res
                    )
                    raise errors.RotateSigningSecretServerError(response_data, http_res)
                except errors.ResponseValidationError as e:
                    raise errors.GenAiDefaultError(
                        "Error response body did not match expected schema",
                        http_res,
