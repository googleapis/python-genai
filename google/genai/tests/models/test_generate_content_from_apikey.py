...
def test_simple_request(client):
  ...
  client.api_client.project = None
  client.api_client.location = None
  ...
  client.api_client._http_options['headers']['x-goog-api-key'] = 'key'
  if not client.api_client.vertexai:
    return
