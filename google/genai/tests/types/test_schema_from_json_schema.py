...
def test_union_like_type_conversion_suite1():
  ...
  gemini_api_json_schema = types.JSONSchema(
      type=[
          types.JSONSchemaType('string'),
          types.JSONSchemaType('object'),
          types.JSONSchemaType('null'),
  ...
  vertex_ai_json_schema = gemini_api_json_schema.copy()
  vertex_ai_json_schema.default = 'default'
  actual_gemini_api_schema = types.Schema.from_json_schema(
      json_schema=gemini_api_json_schema
  )
  actual_vertex_ai_schema = types.Schema.from_json_schema(
      json_schema=vertex_ai_json_schema, api_option='VERTEX_AI'
  )
  expected_schema = types.Schema(
      nullable=True,
      any_of=[
...
def test_default_field_for_gemini_api():
  """Test conversion of JSONSchema.default to Schema.default"""
  json_schema = types.JSONSchema(
      type=types.JSONSchemaType('string'),
      default='default',
  )
  vertex_ai_json_schema = types.Schema.from_json_schema(
      json_schema=json_schema, api_option='VERTEX_AI'
  )
  expected_schema = types.Schema(
      type='STRING',
  ...
  assert vertex_ai_json_schema == expected_schema
  try:
    types.Schema.from_json_schema(json_schema=json_schema)
