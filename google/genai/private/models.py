...
def _FunctionDeclaration_to_vertex(
  ...
  if getv(from_object, ['parameters']) is not None:
    setv(
        to_object,
        ['parameters'],
        _Schema_to_vertex(getv(from_object, ['parameters']), to_object),
    )
  ...
  if getv(from_object, ['response']) is not None:
    setv(
        to_object,
        ['response'],
        _Schema_to_vertex(getv(from_object, ['response']), to_object),
    )
...
def _GenerateContentResponse_from_mldev(
  ...
  if getv(from_object, ['sendTime']) is not None:
    setv(to_object, ['send_time'], getv(from_object, ['sendTime']))

  if getv(from_object, ['internalDebugInfo']) is not None:
    setv(
        to_object,
        ['internal_debug_info'],
        getv(from_object, ['internalDebugInfo']),
    )
