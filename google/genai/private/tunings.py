...
def _AutoraterConfig_from_mldev(
...
def _CompositeReinforcementTuningRewardConfigWeightedRewardConfig_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
  if getv(from_object, ['rewardConfig']) is not None:
    setv(
        to_object,
        ['reward_config'],
        _SingleReinforcementTuningRewardConfig_from_mldev(
            getv(from_object, ['rewardConfig']), to_object
        ),
    )
...
def _CompositeReinforcementTuningRewardConfig_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
  if getv(from_object, ['weightedRewardConfigs']) is not None:
    setv(
        ...
        [
            _CompositeReinforcementTuningRewardConfigWeightedRewardConfig_from_mldev(
                item, to_object
            )
...
def _EvaluationConfig_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
...
def _GenerationConfig_from_mldev(
  ...
  if getv(from_object, ['logitBias']) is not None:
    setv(to_object, ['logit_bias'], getv(from_object, ['logitBias']))
  ...
  if getv(from_object, ['responseSchema']) is not None:
    setv(
        to_object,
        ['response_schema'],
        _Schema_from_mldev(getv(from_object, ['responseSchema']), to_object),
    )
  ...
  if getv(from_object, ['minP']) is not None:
    setv(to_object, ['min_p'], getv(from_object, ['minP']))
  ...
  if getv(from_object, ['contextConfig']) is not None:
    setv(to_object, ['context_config'], getv(from_object, ['contextConfig']))
...
def _GenerationConfig_from_vertex(
  ...
  if getv(from_object, ['responseSchema']) is not None:
    setv(
        to_object,
        ['response_schema'],
        _Schema_from_vertex(getv(from_object, ['responseSchema']), to_object),
    )
...
def _GenerationConfig_to_vertex(
  ...
  if getv(from_object, ['response_schema']) is not None:
    setv(
        to_object,
        ['responseSchema'],
        _Schema_to_vertex(getv(from_object, ['response_schema']), to_object),
    )
...
def _PreferenceOptimizationSpec_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
  ...
  if getv(from_object, ['evaluationConfig']) is not None:
    setv(
        to_object,
        ['evaluation_config'],
        _EvaluationConfig_from_mldev(
            getv(from_object, ['evaluationConfig']), to_object
        ),
    )

  if getv(from_object, ['exportLastCheckpointOnly']) is not None:
    setv(
        to_object,
        ['export_last_checkpoint_only'],
        getv(from_object, ['exportLastCheckpointOnly']),
    )

  return to_object


def _PreferenceOptimizationSpec_from_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
...
def _ReinforcementTuningAutoraterScorer_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
...
def _ReinforcementTuningSpec_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
  ...
  if getv(from_object, ['singleRewardConfig']) is not None:
    setv(
        ...
        _SingleReinforcementTuningRewardConfig_from_mldev(
            getv(from_object, ['singleRewardConfig']), to_object
        ),
    )

  if getv(from_object, ['compositedRewardConfig']) is not None:
    setv(
        to_object,
        ['composited_reward_config'],
        _CompositeReinforcementTuningRewardConfig_from_mldev(
            getv(from_object, ['compositedRewardConfig']), to_object
        ),
    )
...
def _Schema_from_mldev(
  ...
  if getv(from_object, ['prefixItems']) is not None:
    setv(to_object, ['prefix_items'], getv(from_object, ['prefixItems']))
  ...
  if getv(from_object, ['oneOf']) is not None:
    setv(to_object, ['one_of'], getv(from_object, ['oneOf']))

  if getv(from_object, ['anyOf']) is not None:
    setv(to_object, ['any_of'], getv(from_object, ['anyOf']))

  if getv(from_object, ['allOf']) is not None:
    setv(to_object, ['all_of'], getv(from_object, ['allOf']))

  if getv(from_object, ['not']) is not None:
    setv(to_object, ['not_'], getv(from_object, ['not']))

  if getv(from_object, ['additionalPropertiesSchema']) is not None:
    setv(
        to_object,
        ['additional_properties_schema'],
        getv(from_object, ['additionalPropertiesSchema']),
    )
...
def _SingleReinforcementTuningRewardConfig_from_mldev(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
  ...
  if getv(from_object, ['autoraterScorer']) is not None:
    setv(
        to_object,
        ['autorater_scorer'],
        _ReinforcementTuningAutoraterScorer_from_mldev(
            getv(from_object, ['autoraterScorer']), to_object
        ),
    )
...
def _SupervisedTuningSpec_from_vertex(
    from_object: Union[dict[str, Any], object],
    parent_object: Optional[dict[str, Any]] = None,
) -> dict[str, Any]:
  to_object: dict[str, Any] = {}
...
def _TuningJob_from_mldev(
  ...
  if getv(from_object, ['reinforcementLearningSpec']) is not None:
    setv(
        to_object,
        ['reinforcement_learning_spec'],
        getv(from_object, ['reinforcementLearningSpec']),
    )
  ...
  if getv(from_object, ['preferenceOptimizationSpec']) is not None:
    setv(
        ...
        _PreferenceOptimizationSpec_from_mldev(
            getv(from_object, ['preferenceOptimizationSpec']), to_object
        ),
    )
  ...
  if getv(from_object, ['reinforcementTuningSpec']) is not None:
    setv(
        ...
        _ReinforcementTuningSpec_from_mldev(
            getv(from_object, ['reinforcementTuningSpec']), to_object
        ),
    )
...
def _TuningJob_from_vertex(
  ...
  if getv(from_object, ['supervisedTuningSpec']) is not None:
    setv(
        ...
        _SupervisedTuningSpec_from_vertex(
            getv(from_object, ['supervisedTuningSpec']), to_object
        ),
    )
  ...
  if getv(from_object, ['preferenceOptimizationSpec']) is not None:
    setv(
        to_object,
        ['preference_optimization_spec'],
        _PreferenceOptimizationSpec_from_vertex(
            getv(from_object, ['preferenceOptimizationSpec']), to_object
        ),
    )
