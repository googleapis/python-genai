...
class GeminiNextGenAPIClient(SyncAPIClient):
    ...
    with_raw_response: GeminiNextGenAPIClientWithRawResponse
    with_streaming_response: GeminiNextGenAPIClientWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = GeminiNextGenAPIClientWithRawResponse(self)
        self.with_streaming_response = GeminiNextGenAPIClientWithStreamedResponse(self)
...
class AsyncGeminiNextGenAPIClient(AsyncAPIClient):
    ...
    with_raw_response: AsyncGeminiNextGenAPIClientWithRawResponse
    with_streaming_response: AsyncGeminiNextGenAPIClientWithStreamedResponse
    ...
    def __init__(
        ...
        *,
        ...
        self.with_raw_response = AsyncGeminiNextGenAPIClientWithRawResponse(self)
        self.with_streaming_response = AsyncGeminiNextGenAPIClientWithStreamedResponse(self)
