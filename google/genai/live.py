...
class AsyncSession:
  ...
  def _t_content_strict(self, content):
  ...
  def _t_contents_strict(self, contents):
    if isinstance(contents, Sequence):
      return [self._t_content_strict(content) for content in contents]
    else:
      return [self._t_content_strict(contents)]
  ...
  def _t_client_content(
    ...
    try:
      return types.LiveClientContent(
          turns=self._t_contents_strict(contents=turns),
