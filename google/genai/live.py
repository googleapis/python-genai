...
from . import _api_module, _common, _mcp_utils, errors, types
                ...
                if isinstance(item, dict):
                    ...
                    if (
                        ...
                        if function_response_dict.get("id"):
                            function_response_typeddict["id"] = (
    ...
    async def connect(
        ...
        *,
        ...
        if self._api_client.api_key and not self._api_client.vertexai:
            ...
            version = self._api_client._http_options.api_version
            has_sufficient_auth = self._api_client.project and self._api_client.location
