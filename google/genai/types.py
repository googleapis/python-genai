...
class CancelBatchJobResponse(_common.BaseModel):
  """Response for batches.cancel response."""
...
class CancelBatchJobResponseDict(TypedDict, total=False):
  """Response for batches.cancel response."""
...
CancelBatchJobResponseOrDict = Union[
    CancelBatchJobResponse, CancelBatchJobResponseDict
]
