...
class FunctionDeclaration(_common.BaseModel):
  ...
  def from_callable_with_api_option(
      ...
      *,
      ...
      api_option: Literal['ENTERPRISE', 'GEMINI_API'] = 'GEMINI_API',
      behavior: Optional[Behavior] = None,
  ) -> 'FunctionDeclaration':
    """Converts a Callable to a FunctionDeclaration based on the API option.

    Supported API option is 'ENTERPRISE' or 'GEMINI_API'. If api_option is
    unset,
    it will default to 'GEMINI_API'. If unsupported api_option is provided, it
    will raise ValueError.
    """
    supported_api_options = ['ENTERPRISE', 'GEMINI_API']
    ...
    try:
      ...
      # pydantic doesn't assign the `type` field when the schema has 'anyOf'.
      # but Vertex requires it.
      if not 'type' in response_json_schema and 'anyOf' in response_json_schema:
  ...
  def from_callable(
    ...
    if client.vertexai:
      return cls.from_callable_with_api_option(
          callable=callable, api_option='ENTERPRISE', behavior=behavior
      )
    else:
      return cls.from_callable_with_api_option(
