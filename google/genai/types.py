...
class NullValue(_common.CaseInSensitiveEnum):
  """Null value."""

  NULL_VALUE_NONE = 'NULL_VALUE_NONE'
  """Null value"""
...
class PartialArg(_common.BaseModel):
  ...
  null_value: Optional[NullValue] = Field(
      default=None, description="""The null value of the partial argument."""
  )
  ...
  json_path: Optional[str] = Field(
      default=None,
      description="""Required. A JSON Path (RFC 9535) to the argument being streamed.
  ...
  will_continue: Optional[bool] = Field(
      default=None,
      description="""Optional. Whether this is not the last part of the same json_path.
...
class PartialArgDict(TypedDict, total=False):
  ...
  """The null value of the partial argument."""
...
class FunctionCall(_common.BaseModel):
  ...
  partial_args: Optional[PartialArg] = Field(
      default=None,
      description="""The partial arguments of the function call. This is only used for function call that is streamed out in multiple parts/contents/responses.""",
  )
...
class FunctionCallDict(TypedDict, total=False):
  ...
  partial_args: Optional[PartialArgDict]
  """The partial arguments of the function call. This is only used for function call that is streamed out in multiple parts/contents/responses."""
...
class FunctionCallingConfig(_common.BaseModel):
  ...
  allowed_function_names: Optional[list[str]] = Field(
      default=None,
      description="""Optional. Function names to call. Only set when the Mode is ANY.
...
class FunctionCallingConfigDict(TypedDict, total=False):
  ...
  """Optional. When set to true, arguments of a single function call
      will be streamed out in multiple parts/contents/responses. Partial
      parameter results will be returned in the [FunctionCall.partial_args]
      field.
      """
...
class ReplicatedVoiceConfig(_common.BaseModel):
  ...
  mime_type: Optional[str] = Field(
      default=None,
      description="""Optional. The mimetype of the voice sample. Currently only mime_type=audio/pcm is supported, which is raw mono 16-bit signed little-endian pcm data, with 24k sampling rate.""",
  )
  voice_sample_audio: Optional[bytes] = Field(
      default=None, description="""Optional. The sample of the custom voice."""
  )
...
class VoiceConfig(_common.BaseModel):
  ...
  replicated_voice_config: Optional[ReplicatedVoiceConfig] = Field(
      default=None,
      description="""Optional. The configuration for a replicated voice. This enables users to replicate a voice from an audio sample. This field is not supported in Gemini API.""",
  )
...
class VoiceConfigDict(TypedDict, total=False):
  ...
  """Optional. The configuration for a replicated voice. This enables users to replicate a voice from an audio sample. This field is not supported in Gemini API."""
