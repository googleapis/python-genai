...
import typing
from typing import Any, Callable, Literal, Optional, Self, Sequence, Union, _UnionGenericAlias  # type: ignore
import pydantic
...
class Operation(ABC):
  ...
  def from_api_response(
      self, api_response: dict[str, Any], is_vertex_ai: bool = False
  ) -> Self:
...
class GenerateVideosOperation(_common.BaseModel, Operation):
  ...
  def from_api_response(
    ...
    new_operation = GenerateVideosOperation()
