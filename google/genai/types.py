...
class BatchState(_common.CaseInSensitiveEnum):
  """Output only.

  The state of the batch. This enum is not supported in Vertex AI.
  """
  ...
  BATCH_STATE_RUNNING = 'BATCH_STATE_RUNNING'
  """The batch is in progress."""
  BATCH_STATE_SUCCEEDED = 'BATCH_STATE_SUCCEEDED'
  """The batch completed successfully."""
  BATCH_STATE_FAILED = 'BATCH_STATE_FAILED'
  """The batch failed."""
  BATCH_STATE_CANCELLED = 'BATCH_STATE_CANCELLED'
  """The batch has been cancelled."""
  BATCH_STATE_EXPIRED = 'BATCH_STATE_EXPIRED'
  """The batch has expired."""


class TaskType(_common.CaseInSensitiveEnum):
  """The task type of the embedding."""

  TASK_TYPE_UNSPECIFIED = 'TASK_TYPE_UNSPECIFIED'
  """Unset value, which will default to one of the other enum values. This enum value is not supported in Vertex AI."""
  ...
  """Unset value, which will default to one of the other enum values. This enum value is not supported in Gemini API."""
...
class GroundingChunkMapsPlaceAnswerSourcesReviewSnippet(_common.BaseModel):
  ...
  title: Optional[str] = Field(
      default=None, description="""The title of the review."""
  )
...
class GroundingChunkMapsPlaceAnswerSources(_common.BaseModel):
  ...
  answer, as well as URIs to flag content. This data type is not supported in
  Gemini API.
  """
...
class GroundingChunkMaps(_common.BaseModel):
  ...
  This is used to provide the user with rich, location-based information. This
  data type is not supported in Gemini API.
  """
...
class Segment(_common.BaseModel):
  ...
  text: Optional[str] = Field(
      default=None, description="""Output only. The text of the segment."""
  )
...
class RetrievalMetadata(_common.BaseModel):
  ...
  This is part of the `GroundingMetadata` returned when grounding is enabled.
  """
...
class SearchEntryPoint(_common.BaseModel):
  ...
  response is Google Search. It provides information that you can use to display
  the search results in your application.
  """
...
class EmbedContentBatchStats(_common.BaseModel):
  ...
  successful_request_count: Optional[int] = Field(
      default=None,
      description="""Output only. The number of requests that were successfully processed.""",
  )


class EmbedContentBatchStatsDict(TypedDict, total=False):
  """Stats about the batch. This data type is not supported in Vertex AI."""

  failed_request_count: Optional[int]
  """Output only. The number of requests that failed to be processed."""

  pending_request_count: Optional[int]
  ...
  successful_request_count: Optional[int]
  """Output only. The number of requests that were successfully processed."""


EmbedContentBatchStatsOrDict = Union[
    EmbedContentBatchStats, EmbedContentBatchStatsDict
]


class EmbedContentRequest(_common.BaseModel):
  """Request message for PredictionService.EmbedContent."""

  auto_truncate: Optional[bool] = Field(
      default=None,
      description="""Optional. Whether to silently truncate the input content if it's longer than the maximum sequence length. This field is not supported in Gemini API.""",
  )
  content: Optional[Content] = Field(
      default=None,
  ...
  task_type: Optional[TaskType] = Field(
      default=None, description="""Optional. The task type of the embedding."""
  )
  title: Optional[str] = Field(
      default=None, description="""Optional. An optional title for the text."""
  )
  model: Optional[str] = Field(
      default=None,
      description="""Required. The model's resource name. This serves as an ID for the Model to use. This name should match a model name returned by the `ListModels` method. Format: `models/{model}`. This field is not supported in Vertex AI.""",
  )


class EmbedContentRequestDict(TypedDict, total=False):
  """Request message for PredictionService.EmbedContent."""

  auto_truncate: Optional[bool]
  """Optional. Whether to silently truncate the input content if it's longer than the maximum sequence length. This field is not supported in Gemini API."""
  ...
  model: Optional[str]
  """Required. The model's resource name. This serves as an ID for the Model to use. This name should match a model name returned by the `ListModels` method. Format: `models/{model}`. This field is not supported in Vertex AI."""


EmbedContentRequestOrDict = Union[EmbedContentRequest, EmbedContentRequestDict]


class InlinedEmbedContentRequest(_common.BaseModel):
  ...
  request: Optional[EmbedContentRequest] = Field(
      default=None,
      description="""Required. The request to be processed in the batch.""",
  )


class InlinedEmbedContentRequestDict(TypedDict, total=False):
  """The request to be processed in the batch.
  ...
  request: Optional[EmbedContentRequestDict]
  """Required. The request to be processed in the batch."""


InlinedEmbedContentRequestOrDict = Union[
    InlinedEmbedContentRequest, InlinedEmbedContentRequestDict
]


class InlinedEmbedContentRequests(_common.BaseModel):
  """The requests to be processed in the batch if provided as part of the batch creation request.

  This data type is not supported in Vertex AI.
  """

  requests: Optional[list[InlinedEmbedContentRequest]] = Field(
      default=None,
      description="""Required. The requests to be processed in the batch.""",
  )


class InlinedEmbedContentRequestsDict(TypedDict, total=False):
  """The requests to be processed in the batch if provided as part of the batch creation request.

  This data type is not supported in Vertex AI.
  """

  requests: Optional[list[InlinedEmbedContentRequestDict]]
  """Required. The requests to be processed in the batch."""


InlinedEmbedContentRequestsOrDict = Union[
    InlinedEmbedContentRequests, InlinedEmbedContentRequestsDict
]


class InputEmbedContentConfig(_common.BaseModel):
  ...
  requests: Optional[InlinedEmbedContentRequests] = Field(
      default=None, description="""The requests to be processed in the batch."""
  )


class InputEmbedContentConfigDict(TypedDict, total=False):
  """Configures the input to the batch request.
  ...
  requests: Optional[InlinedEmbedContentRequestsDict]
  """The requests to be processed in the batch."""


InputEmbedContentConfigOrDict = Union[
    InputEmbedContentConfig, InputEmbedContentConfigDict
]


class InlinedEmbedContentResponses(_common.BaseModel):
  """The responses to the requests in the batch.

  This data type is not supported in Vertex AI.
  """

  inlined_responses: Optional[list[InlinedEmbedContentResponse]] = Field(
      default=None,
      description="""Output only. The responses to the requests in the batch.""",
  )


class InlinedEmbedContentResponsesDict(TypedDict, total=False):
  """The responses to the requests in the batch.

  This data type is not supported in Vertex AI.
  """

  inlined_responses: Optional[list[InlinedEmbedContentResponseDict]]
  """Output only. The responses to the requests in the batch."""


InlinedEmbedContentResponsesOrDict = Union[
    InlinedEmbedContentResponses, InlinedEmbedContentResponsesDict
]


class EmbedContentBatchOutput(_common.BaseModel):
  """The output of a batch request.

  This is returned in the `AsyncBatchEmbedContentResponse` or the
  `EmbedContentBatch.output` field. This data type is not supported in Vertex
  AI.
  """

  inlined_responses: Optional[InlinedEmbedContentResponses] = Field(
      default=None,
  ...
  responses_file: Optional[str] = Field(
      default=None,
...
class EmbedContentBatchOutputDict(TypedDict, total=False):
  """The output of a batch request.
  ...
  inlined_responses: Optional[InlinedEmbedContentResponsesDict]
...
EmbedContentBatchOutputOrDict = Union[
    EmbedContentBatchOutput, EmbedContentBatchOutputDict
]
...
class EmbedContentBatch(_common.BaseModel):
  ...
  batch_stats: Optional[EmbedContentBatchStats] = Field(
      default=None, description="""Output only. Stats about the batch."""
  )
  create_time: Optional[datetime.datetime] = Field(
      default=None,
  ...
  input_config: Optional[InputEmbedContentConfig] = Field(
      default=None,
  ...
  output: Optional[EmbedContentBatchOutput] = Field(
      default=None,
  ...
  state: Optional[BatchState] = Field(
      default=None, description="""Output only. The state of the batch."""
  )
  update_time: Optional[datetime.datetime] = Field(
      default=None,
...
class EmbedContentBatchDict(TypedDict, total=False):
  ...
  batch_stats: Optional[EmbedContentBatchStatsDict]
  ...
  input_config: Optional[InputEmbedContentConfigDict]
  ...
  output: Optional[EmbedContentBatchOutputDict]
