...
class ThinkingLevel(_common.CaseInSensitiveEnum):
  ...
  If not specified, the default is HIGH. Recommended for Gemini 3 or later
  models. Use with earlier models results in an error. This enum is not
...
class ThinkingConfig(_common.BaseModel):
  ...
  thinking_level: Optional[ThinkingLevel] = Field(
      default=None,
      description="""Optional. Controls the maximum depth of the model's internal reasoning process before it produces a response. If not specified, the default is HIGH. Recommended for Gemini 3 or later models. Use with earlier models results in an error. This field is not supported in Vertex AI.""",
  )
...
class ThinkingConfigDict(TypedDict, total=False):
  ...
  """Optional. Controls the maximum depth of the model's internal reasoning process before it produces a response. If not specified, the default is HIGH. Recommended for Gemini 3 or later models. Use with earlier models results in an error. This field is not supported in Vertex AI."""
