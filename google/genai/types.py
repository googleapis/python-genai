...
class Schema(_common.BaseModel):
  ...
  def from_json_schema(
    ...
    gemini_api_unsupported_field_names: tuple[str, ...] = ('default',)
    ...
    def normalize_json_schema_type(
      ...
      if type(json_schema_type) is str:
    ...
    def raise_error_if_cannot_convert(
      ...
      for field_name, field_value in json_schema_dict.items():
        if field_value is None:
          continue
        if (
            field_name not in google_schema_field_names
            and raise_error_on_unsupported_field
        ):
          raise ValueError((
    ...
    def convert_json_schema(
      ...
      # At the highest level of the logic, there are two cases:
      # Case 1: the JSONSchema.type is union-like,
      ...
      #         Detailed logic is commented below with `Case 1` keyword tag.
      # Case 2: the JSONSchema.type is not union-like,
      #         e.g. 'string', ['string'], ['null', 'string'].
      #         for this case, no splitting is needed. Detailed
      #         logic is commented below with `Case 2` keyword tag.
      #
      #
      # Case 1: the JSONSchema.type is union-like
      #         e.g. ['null', 'string', 'array'].
