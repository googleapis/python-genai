...
class ModelContent(Content):
  ...
  - Create a model Content object with a string:
    model_content = ModelContent(parts="Why is the sky blue?")
  - Create a model Content object with a file data Part object:
    model_content = ModelContent(parts=Part.from_uri(file_uril="gs://bucket/file.txt",
    mime_type="text/plain"))
  - Create a model Content object with byte data Part object:
    model_content = ModelContent(parts=Part.from_bytes(data=b"Hello, World!",
    mime_type="text/plain"))
