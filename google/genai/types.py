...
class VideoGenerationMask(_common.BaseModel):
  ...
  mask_mode: Optional[str] = Field(
      default=None,
      description="""Describes how the mask will be used. Inpainting masks must match
      the aspect ratio of the input video. Outpainting masks can be either 9:16
      or 16:9.""",
  )
...
class VideoGenerationMaskDict(TypedDict, total=False):
  ...
  """Describes how the mask will be used. Inpainting masks must match
      the aspect ratio of the input video. Outpainting masks can be either 9:16
      or 16:9."""
