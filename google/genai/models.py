...
def _GenerateVideosSource_to_mldev(
    ...
    to_object: dict[str, Any] = {}
    if getv(from_object, ["prompt"]) is not None:
        setv(parent_object, ["instances[0]", "prompt"], getv(from_object, ["prompt"]))
...
def _GeneratedImageMask_from_vertex(
    ...
    if getv(from_object, ["labels"]) is not None:
        setv(to_object, ["labels"], [item for item in getv(from_object, ["labels"])])
...
def _GenerationConfig_to_vertex(
    ...
    if getv(from_object, ["speech_config"]) is not None:
        setv(
            to_object,
            ["speechConfig"],
            _SpeechConfig_to_vertex(getv(from_object, ["speech_config"]), to_object),
        )
...
def _GoogleSearch_to_mldev(
    ...
    if getv(from_object, ["exclude_domains"]) is not None:
        raise ValueError("exclude_domains parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["time_range_filter"]) is not None:
        setv(to_object, ["timeRangeFilter"], getv(from_object, ["time_range_filter"]))
...
def _ListModelsParameters_to_mldev(
    ...
    to_object: dict[str, Any] = {}
    if getv(from_object, ["config"]) is not None:
        _ListModelsConfig_to_mldev(api_client, getv(from_object, ["config"]), to_object)
...
def _SegmentImageSource_to_vertex(
    ...
    if getv(from_object, ["scribble_image"]) is not None:
        setv(
            ...
            _ScribbleImage_to_vertex(getv(from_object, ["scribble_image"]), to_object),
        )
...
class Models(_api_module.BaseModule):
    ...
    def generate_content(
        ...
        *,
        ...
        incompatible_tools_indexes = _extra_utils.find_afc_incompatible_tool_indexes(
            config
        )
        ...
        async def async_generator(model, contents, config):  # type: ignore[no-untyped-def]
            ...
            while remaining_remote_calls_afc > 0:
                ...
                if i == 1:
                    ...
                    async for chunk in response:  # type: ignore[attr-defined]
                        if not function_map:
                            contents = _extra_utils.append_chunk_contents(
                                contents, chunk
                            )
                            yield chunk
                        else:
