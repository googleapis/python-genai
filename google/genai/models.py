...
def _Schema_to_mldev(
    ...
    if getv(from_object, ["max_properties"]) is not None:
        setv(
            to_object, ["maxProperties"], getv(from_object, ["max_properties"])
        )
    ...
    if getv(from_object, ["min_properties"]) is not None:
        setv(
            to_object, ["minProperties"], getv(from_object, ["min_properties"])
        )
...
def _ApiKeyConfig_to_mldev(
    ...
    if getv(from_object, ["api_key_string"]) is not None:
        raise ValueError(
            "api_key_string parameter is not supported in Gemini API."
        )
...
def _AuthConfig_to_mldev(
    ...
    if getv(from_object, ["api_key_config"]) is not None:
        raise ValueError(
            "api_key_config parameter is not supported in Gemini API."
        )
...
def _GoogleMaps_to_mldev(
    ...
    if getv(from_object, ["auth_config"]) is not None:
        raise ValueError(
            "auth_config parameter is not supported in Gemini API."
        )
...
def _Tool_to_mldev(
    ...
    if getv(from_object, ["code_execution"]) is not None:
        setv(
            to_object, ["codeExecution"], getv(from_object, ["code_execution"])
        )
...
def _ThinkingConfig_to_mldev(
    ...
    if getv(from_object, ["include_thoughts"]) is not None:
        setv(
            to_object,
            ["includeThoughts"],
            getv(from_object, ["include_thoughts"]),
        )
    ...
    if getv(from_object, ["thinking_budget"]) is not None:
        setv(
            to_object,
            ["thinkingBudget"],
            getv(from_object, ["thinking_budget"]),
        )
...
def _GenerateContentConfig_to_mldev(
    ...
    if getv(from_object, ["system_instruction"]) is not None:
        setv(
            ...
            _Content_to_mldev(
                api_client,
                t.t_content(
                    api_client, getv(from_object, ["system_instruction"])
                ),
                to_object,
            ),
        )
    ...
    if getv(from_object, ["stop_sequences"]) is not None:
        setv(
            to_object, ["stopSequences"], getv(from_object, ["stop_sequences"])
        )
    ...
    if getv(from_object, ["presence_penalty"]) is not None:
        setv(
            to_object,
            ["presencePenalty"],
            getv(from_object, ["presence_penalty"]),
        )
    ...
    if getv(from_object, ["routing_config"]) is not None:
        raise ValueError(
            "routing_config parameter is not supported in Gemini API."
        )
    ...
    if getv(from_object, ["tools"]) is not None:
        setv(
            ...
            [
                _Tool_to_mldev(
                    api_client, t.t_tool(api_client, item), to_object
                )
...
def _EmbedContentConfig_to_mldev(
    ...
    if getv(from_object, ["title"]) is not None:
        setv(
            parent_object, ["requests[]", "title"], getv(from_object, ["title"])
        )
    ...
    if getv(from_object, ["auto_truncate"]) is not None:
        raise ValueError(
            "auto_truncate parameter is not supported in Gemini API."
        )
...
def _GenerateImagesConfig_to_mldev(
    ...
    if getv(from_object, ["add_watermark"]) is not None:
        raise ValueError(
            "add_watermark parameter is not supported in Gemini API."
        )

    if getv(from_object, ["enhance_prompt"]) is not None:
        raise ValueError(
            "enhance_prompt parameter is not supported in Gemini API."
        )
...
def _GenerateImagesParameters_to_mldev(
    ...
    if getv(from_object, ["prompt"]) is not None:
        setv(
            to_object, ["instances[0]", "prompt"], getv(from_object, ["prompt"])
        )
...
def _UpdateModelConfig_to_mldev(
    ...
    if getv(from_object, ["display_name"]) is not None:
        setv(
            parent_object, ["displayName"], getv(from_object, ["display_name"])
        )
...
def _GenerateVideosConfig_to_mldev(
    ...
    if getv(from_object, ["pubsub_topic"]) is not None:
        raise ValueError(
            "pubsub_topic parameter is not supported in Gemini API."
        )
...
def _GenerateVideosParameters_to_mldev(
    ...
    if getv(from_object, ["image"]) is not None:
        setv(
            ...
            ["instances[0]", "image"],
            _Image_to_mldev(
                api_client, getv(from_object, ["image"]), to_object
            ),
        )
...
def _SpeakerVoiceConfig_to_vertex(
    ...
    if getv(from_object, ["voice_config"]) is not None:
        raise ValueError(
            "voice_config parameter is not supported in Vertex AI."
        )
...
def _GenerateContentConfig_to_vertex(
    ...
    if getv(from_object, ["routing_config"]) is not None:
        setv(
            to_object, ["routingConfig"], getv(from_object, ["routing_config"])
        )
    ...
    if getv(from_object, ["audio_timestamp"]) is not None:
        setv(
            to_object,
            ["audioTimestamp"],
            getv(from_object, ["audio_timestamp"]),
        )
...
def _MaskReferenceConfig_to_vertex(
    ...
    if getv(from_object, ["segmentation_classes"]) is not None:
        setv(
            to_object,
            ["maskClasses"],
            getv(from_object, ["segmentation_classes"]),
        )
...
def _ReferenceImageAPI_to_vertex(
    ...
    if getv(from_object, ["reference_type"]) is not None:
        setv(
            to_object, ["referenceType"], getv(from_object, ["reference_type"])
        )
    ...
    if getv(from_object, ["control_image_config"]) is not None:
        setv(
            ...
            _ControlReferenceConfig_to_vertex(
                api_client,
                getv(from_object, ["control_image_config"]),
                to_object,
            ),
        )
...
def _GenerateVideosParameters_to_vertex(
    ...
    if getv(from_object, ["video"]) is not None:
        setv(
            ...
            ["instances[0]", "video"],
            _Video_to_vertex(
                api_client, getv(from_object, ["video"]), to_object
            ),
        )
...
def _FeatureSelectionPreference_to_mldev_enum_validate(enum_value: Any) -> None:
    if enum_value in set(
        ...
        raise ValueError(
            f"{enum_value} enum value is not supported in Gemini API."
        )
...
def _Behavior_to_vertex_enum_validate(enum_value: Any) -> None:
    if enum_value in set(["UNSPECIFIED", "BLOCKING", "NON_BLOCKING"]):
        raise ValueError(
            f"{enum_value} enum value is not supported in Vertex AI."
        )
...
def _Part_from_mldev(
    ...
    if getv(from_object, ["executableCode"]) is not None:
        setv(
            to_object,
            ["executable_code"],
            getv(from_object, ["executableCode"]),
        )
...
def _Candidate_from_mldev(
    ...
    if getv(from_object, ["logprobsResult"]) is not None:
        setv(
            to_object,
            ["logprobs_result"],
            getv(from_object, ["logprobsResult"]),
        )

    if getv(from_object, ["safetyRatings"]) is not None:
        setv(
            to_object, ["safety_ratings"], getv(from_object, ["safetyRatings"])
        )
...
def _GenerateContentResponse_from_mldev(
    ...
    if getv(from_object, ["promptFeedback"]) is not None:
        setv(
            to_object,
            ["prompt_feedback"],
            getv(from_object, ["promptFeedback"]),
        )

    if getv(from_object, ["usageMetadata"]) is not None:
        setv(
            to_object, ["usage_metadata"], getv(from_object, ["usageMetadata"])
        )
...
def _SafetyAttributes_from_mldev(
    ...
    if getv(from_object, ["safetyAttributes", "scores"]) is not None:
        setv(
            to_object,
            ["scores"],
            getv(from_object, ["safetyAttributes", "scores"]),
        )
...
def _Model_from_mldev(
    ...
    if getv(from_object, ["inputTokenLimit"]) is not None:
        setv(
            to_object,
            ["input_token_limit"],
            getv(from_object, ["inputTokenLimit"]),
        )
...
def _Candidate_from_vertex(
    ...
    if getv(from_object, ["finishMessage"]) is not None:
        setv(
            to_object, ["finish_message"], getv(from_object, ["finishMessage"])
        )
...
def _Endpoint_from_vertex(
    ...
    if getv(from_object, ["deployedModelId"]) is not None:
        setv(
            to_object,
            ["deployed_model_id"],
            getv(from_object, ["deployedModelId"]),
        )
...
class Models(_api_module.BaseModule):
    ...
    def generate_videos(
        ...
        *,
        ...
        2b. Image to video generation with frame interpolation (specify last_frame in config).
