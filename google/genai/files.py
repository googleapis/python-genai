...
def _File_to_mldev(
    ...
    if getv(from_object, ["expiration_time"]) is not None:
        setv(
            to_object,
            ["expirationTime"],
            getv(from_object, ["expiration_time"]),
        )
    ...
    if getv(from_object, ["video_metadata"]) is not None:
        setv(
            to_object, ["videoMetadata"], getv(from_object, ["video_metadata"])
        )
...
def _File_from_mldev(
    ...
    if getv(from_object, ["expirationTime"]) is not None:
        setv(
            to_object,
            ["expiration_time"],
            getv(from_object, ["expirationTime"]),
        )
    ...
    if getv(from_object, ["videoMetadata"]) is not None:
        setv(
            to_object, ["video_metadata"], getv(from_object, ["videoMetadata"])
        )
...
class Files(_api_module.BaseModule):
    ...
    def delete(
        ...
        *,
        name: str,
        config: Optional[types.DeleteFileConfigOrDict] = None,
    ...
    def upload(
        ...
        *,
        ...
        response = self._create(
            file=file_obj,
            config=types.CreateFileConfig(http_options=http_options),
        )
        ...
        return types.File._from_response(
            response=_File_from_mldev(
                self._api_client, return_file.json["file"]
            ),
