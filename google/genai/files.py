...
class Files(_api_module.BaseModule):
  ...
  def _list(
    ...
    response_dict = (
        '' if not response_dict['body'] else json.loads(response_dict['body'])
    )
  ...
  def _create(
    ...
    if config is not None and hasattr(config, 'should_return_http_response'):
      return_value = types.CreateFileResponse(sdk_http_response=response_dict)
      self._api_client._verify_response(return_value)
      return return_value
