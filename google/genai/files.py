...
def _File_to_mldev(
  ...
  if getv(from_object, ['size_bytes']) is not None:
    setv(to_object, ['size_bytes'], getv(from_object, ['size_bytes']))

  if getv(from_object, ['create_time']) is not None:
    setv(to_object, ['create_time'], getv(from_object, ['create_time']))

  if getv(from_object, ['expiration_time']) is not None:
    setv(to_object, ['expiration_time'], getv(from_object, ['expiration_time']))

  if getv(from_object, ['update_time']) is not None:
    setv(to_object, ['update_time'], getv(from_object, ['update_time']))

  if getv(from_object, ['sha256_hash']) is not None:
    setv(to_object, ['sha256_hash'], getv(from_object, ['sha256_hash']))

  if getv(from_object, ['uri']) is not None:
    setv(to_object, ['uri'], getv(from_object, ['uri']))

  if getv(from_object, ['download_uri']) is not None:
    setv(to_object, ['download_uri'], getv(from_object, ['download_uri']))
  ...
  if getv(from_object, ['video_metadata']) is not None:
    setv(to_object, ['video_metadata'], getv(from_object, ['video_metadata']))
