...
We recommend using our Code Generation instructions [`llms.txt`](https://raw.githubusercontent.com/googleapis/python-genai/refs/heads/main/llms.txt) when generating Google Gen AI SDK code to guide your model towards using the more recent SDK features. Copy and paste the instructions into your development environment to provide the model with the necessary context.
